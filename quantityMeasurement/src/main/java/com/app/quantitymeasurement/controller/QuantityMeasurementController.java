...
public class QuantityMeasurementController {
  ...
  public ResponseEntity<QuantityMeasurementDTO> compareQuantities(@Valid @RequestBody QuantityInputDTO inputDTO) {
    return ResponseEntity.ok(service.compareQuantities(inputDTO.getThisQuantityDTO(), inputDTO.getThatQuantityDTO()));
  }
  ...
  public ResponseEntity<QuantityMeasurementDTO> convertQuantity(@Valid @RequestBody QuantityInputDTO inputDTO) {
    return ResponseEntity.ok(service.convertQuantity(inputDTO.getThisQuantityDTO(), inputDTO.getThatQuantityDTO()));
  }

  @PostMapping("/add")
  @Operation(summary = "Add two quantities")
  public ResponseEntity<QuantityMeasurementDTO> addQuantities(@Valid @RequestBody QuantityInputDTO inputDTO) {
    return ResponseEntity.ok(service.addQuantities(inputDTO.getThisQuantityDTO(), inputDTO.getThatQuantityDTO()));
  }

  @PostMapping("/subtract")
  @Operation(summary = "Subtract two quantities")
  public ResponseEntity<QuantityMeasurementDTO> subtractQuantities(@Valid @RequestBody QuantityInputDTO inputDTO) {
    return ResponseEntity.ok(service.subtractQuantities(inputDTO.getThisQuantityDTO(), inputDTO.getThatQuantityDTO()));
  }

  @PostMapping("/divide")
  @Operation(summary = "Divide two quantities")
  public ResponseEntity<QuantityMeasurementDTO> divideQuantities(@Valid @RequestBody QuantityInputDTO inputDTO) {
    return ResponseEntity.ok(service.divideQuantities(inputDTO.getThisQuantityDTO(), inputDTO.getThatQuantityDTO()));
  }
